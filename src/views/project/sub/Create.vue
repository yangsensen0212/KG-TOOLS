<template>
    <el-form ref="projectForm" :model="form" label-width="200px">
        ...
        <el-form-item label="关系定义（逗号分隔）：">
            <el-input v-model="form.relationshipDefinition" type="textarea" :rows="4" style="width: 400px;"></el-input>
        </el-form-item>
        <el-form-item label="项目描述：">
            <!-- 增加项目描述的输入框高度 -->
            <el-input v-model="form.description" type="textarea" :rows="7" style="width: 400px;">
            </el-input>
        </el-form-item>
    </el-form>
</template>
