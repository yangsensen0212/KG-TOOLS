<template>
    <div class="terminal">
        <el-input type="textarea" v-model="terminalOutput" :rows="10" readonly class="terminal-output"></el-input>
        <el-input v-model="currentCommand" placeholder="输入命令..." @keyup.enter="executeCommand" class="command-input"
            autofocus>
