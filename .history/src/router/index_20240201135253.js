 ...
 */
//钻孔柱状图提取
import Drill from '@/views/CAD/Drill'
import ContourLine from '@/views/CAD/ContourLine.vue'
import CreateProject from '@/views/project/New'
import Manage from '@/views/project/Manage'
import Visual from '@/views/apply/Visual'
// 机器信息管理
